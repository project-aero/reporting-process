...
# lines(y = tychoL1.measles.CA.pad$cases, col=1, lwd=1.5, x = tychoL1.measles.CA.pad$enddate, type='l')
# 
# plot_ly(data = tychoL1.measles.CA, line = list(shape = "vh"),
#         x = ~enddate, y = ~cases.imp
#         )
# 
# 
...
# 
# plot(tychoL1.measles.CA.cases.imp.zoo.4wk, col=3)
# lines(tychoL1.measles.CA.cases.imp.zoo.2wk, col=2)
# lines(tychoL1.measles.CA.cases.imp.zoo)
# 
...
# PDF output
pdf(
  file = "./output/plots/fig1_revised.pdf",
...
lines(window(tmp.zoo, end=peakdate - bandwidth), 
...
rect(peakdate-bandwidth, 0, plotxmax+bandwidth, 1, border = F, col = color.shaded)
...
lines(tychoL1.measles.CA.cases.imp.zoo.statswindow.4wk, col=color.30day.imperfect, type='S')
lines(tychoL1.measles.CA.cases.imp.zoo.statswindow.2wk, col=color.7day.imperfect, type='S')
tmp.zoo <- window(tychoL1.measles.CA.cases.imp.zoo,start=plotxmin,end=peakdate)
lines(tychoL1.measles.CA.cases.imp.zoo.statswindow, col="black", type='S', lwd=.25)
...
# rect(peakdate, 0, plotxmax+bandwidth, plotymax, border = F, col = color.shaded)

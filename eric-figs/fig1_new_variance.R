...
obsdate <- cdcweekToDate(year=1990, week=34-52, weekday=6)

# end date for plot of stats
statsend <- obsdate-2*bandwidth
...
# PDF output
pdf(
  file = "./output/plots/fig1_revised_alt2.pdf",
...
rect(obsdate, -1, plotxmax+bandwidth, 1, border = F, col = color.shaded)

## shade stats window 

rect(statsend-bandwidth, -1, statsend+bandwidth, 1, border = F, col = rgb(1.,1.,0.,.5))
...
rect(obsdate, 0, plotxmax+bandwidth, plotymax, border = F, col = color.shaded)

## shade stats window 

rect(statsend-bandwidth, 0, statsend+bandwidth, plotymax, border = F, col = rgb(1.,1.,0.,.5))
